...
jQuery(document).ready( function () {
     ...
     var tabTourbutton  = '<div>' +
                            '<a id="tab_moTour" class="mo_btn mo_btn-danger mo_btn-sm" style="position: absolute;top:160px;right: 40px; padding: 0.3% 0.5%; " onclick="tab_moTour()">Module Tour</a>' +
                          '</div>';
     jQuery(tabTourbutton).insertAfter('.mo_saml_sp_table_layout_1');
